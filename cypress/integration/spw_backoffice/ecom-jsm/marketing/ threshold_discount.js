...
describe("Test Threshold Discount page", () => {
  ...
  it("TC_TD01 - Verify if Threshold Discount page display correctly ", () => {  
    ...
    cy.get("div.page-btn:nth-child(18) > button:nth-child(1)").should("exist")  // Open drop down
    cy.get("div.page-btn:nth-child(18) > button:nth-child(2)").should("exist")  // Reset button
    cy.get("div.page-btn:nth-child(18) > button:nth-child(3)").should("exist")  // Filter button

    // click Open drop down to expand
    cy.get("div.page-btn:nth-child(18) > button:nth-child(1)").click()
    ...
    cy.get("div.page-btn:nth-child(18) > button:nth-child(1)").should("exist")   // Close drop down
